    ...
    teachers = [
        {
            ...
            "role": "teacher",
            "class_id": classes[0]["id"],            # legacy compat
            "class_ids": [classes[0]["id"]],         # nuovo campo
            "child_id": None,
            "child_ids": [],
            "avatar_url": None,
            "active": True,
    ...
    parents = [
        {
            ...
            "role": "parent",
            "class_id": None,                            # non più legato alla classe
            "class_ids": [],
            "child_id": students[0]["id"],               # legacy compat
            "child_ids": [students[0]["id"]],            # nuovo campo
            "avatar_url": None,
            "active": True,
            "created_at": datetime.now(timezone.utc).isoformat(),
        },
